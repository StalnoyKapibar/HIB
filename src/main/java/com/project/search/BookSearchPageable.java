...
@Transactional
@AllArgsConstructor
public class BookSearchPageable {
    ...
    public BookSearchPageDTO search(String req, Long priceFrom, Long priceTo, String yearOfEditionFrom, String yearOfEditionTo, Long pagesFrom,

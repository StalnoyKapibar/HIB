...
properties = {
    ...
    client_idloc: "183482457610-9bp9qfkp3ao3de2cv09sqqfv5mt72vjk.apps.googleusercontent.com",
    ...
    redirect_uriloc: "http://localhost:8080/gmail/admin",
    response_type: "code",
...
gmailAccessUrlloc = {
    fullUrl: properties.authURL + '?'
        + 'client_id=' + properties.client_idloc + '&'
        + 'access_type=' + properties.access_type + '&'
        + 'prompt=' + properties.prompt + '&'
        + 'redirect_uri=' + properties.redirect_uriloc + '&'
        + 'response_type=' + properties.response_type + '&'
        + 'scope=' + properties.scope
}
                ...
                $.each(data, function (index) {
                    let card = `<div class="col mb-4">
                                    <a class="card border-0" href="/page/${data[index].id}" style="color: black">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">${data[index].nameAuthorDTOLocale} (${data[index].nameAuthorTransliteDTOLocale})</h5>
                                            <h6 class="card-text text-muted">${data[index].nameBookDTOLocale} (${data[index].nameBookTransliteDTOLocale})</h6>

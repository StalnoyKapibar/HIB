...
function setLocaleFields() {
    fetch("/properties/" + currentLang)
        ...
        .then(function (localeFields) {
            ...
            $('#author_search_page').text(localeFields['authorSearchPage']);
            $('#name_search_page').text(localeFields['nameSearchPage']);
            $('#pages_search_page').text(localeFields['pageSearchPage']);
            $('#edition_search_page').text(localeFields['editionSearchPage']);
            $('#price_search_page').text(localeFields['priceSearchPage']);
            $('#category_search_page').text(localeFields['categorySearchPage']);
            $('#search_by_search_page_menu').text(localeFields['searchBySearchPageMenu']);
